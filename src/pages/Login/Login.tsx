...
const Login:FC = () => {
    return (
        <div className='flex flex-wrap md:flex-nowrap items-stretch justify-between'>
            <Form classnames={['bg-white', 'w-full', 'md:w-1/2', 'md:mr-4', 'mb-4', 'md:mb-0' , 'rounded', 'shadow-md', 'p-4']}>
            ...
            <Form classnames={['bg-white', 'w-full', 'md:w-1/2', 'md:ml-4' , 'mb-4', 'md:mb-0', 'rounded', 'shadow-md', 'p-4']}>
