...
const Login: FC = () => {
  ...
  return (
    <div className="flex flex-wrap md:flex-nowrap items-stretch justify-between">
      <Form id="login-form"
            classnames={ [ 'bg-white', 'w-full', 'md:w-1/2', 'md:mr-4', 'mb-4', 'md:mb-0', 'rounded', 'shadow-md', 'p-4' ] }
            isValueChanged={ isValueChanged } setIsValueChanged={ setIsValueChanged }
            setSubmitErrors={ setLoginSubmitErrors } submitErrors={ loginSubmitErrors } validation={ LoginValidation } formValueObjectName='loginValues'>
      ...
      <Form id="register-form"
            ...
            isValueChanged={ isValueChanged } setIsValueChanged={ setIsValueChanged }
            setSubmitErrors={ setRegisterSubmitErrors } submitErrors={ registerSubmitErrors } validation={ RegisterValidation } formValueObjectName='registerValues'>
